...
public:    
    ...
    /**
     * @brief Renvoie l'instance actuelle de l'objet UTManager. Si aucune instance n'existe, une nouvelle est créée.
     * @return
     */
    static UTManager* getInstance();
    /**
     * @brief Détruit l'instance actuelle de l'UTManager
     */
    static void destroy();
